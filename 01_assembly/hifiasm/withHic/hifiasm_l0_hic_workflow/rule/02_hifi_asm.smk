...
rule busco:
	input:
		primary_fa = rules.gfa2fa.output.primary_fa,
	output:
		primary_short_summary = "results/03_assembly_assement/02_busco/{sample}_hifiasm.hic.p_ctg/short_summary.specific.solanales_odb10.{sample}_hifiasm.hic.p_ctg.txt",
	shell:
		"""
