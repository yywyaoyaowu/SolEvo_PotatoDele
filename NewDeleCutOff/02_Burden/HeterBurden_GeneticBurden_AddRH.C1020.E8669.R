...
setwd("/Users/wuyaoyao/work/03-evolutionary-dele/06_Sol_evo/03_Results/Paper/Output/NewDeleCutOff/02_Dele/mac3MinDP4_meanminDP3_Quality")
allBurdenIndex.final=read.table("DiploidLandrace182MR0.5_AllChrs_DiffConservationCutoff_BurdenInfo_SolMsaNonMajorDele.txt",header=T)
allBurdenIndex_Constraint=subset(allBurdenIndex.final,ConservationCutoff>=2)

E8669.C1020.RH.other=read.table("DiploidLandrace367MR0.5_Substr182AddNewAccession_DiffConservationCutoff_BurdenInfo.txt",header=T)
E8669.C1020.RH.other2=E8669.C1020.RH.other[,match(names(allBurdenIndex_Constraint),names(E8669.C1020.RH.other))]
E8669.C1020.RH=E8669.C1020.RH.other2[(!grepl("PG",E8669.C1020.RH.other2$sample.id) & E8669.C1020.RH.other2$Chrom=="AllChrs"),]
E8669.C1020.RH$Type="Founder"

BurdenPerAccession=subset(allBurdenIndex_Constraint,Chrom=="AllChrs")
LandranceBurden182=BurdenPerAccession
LandranceBurden182$Type="Landrace"
LandranceBurden=rbind(LandranceBurden182,E8669.C1020.RH)
...
LandranceBurden_GERP2_rm_landrace=subset(All.LandranceBurden_rm,ConservationCutoff==2)
founder_GERP2_infor=subset(Founder,ConservationCutoff==2)
...
Burden_ColIndex=match(c("GeneticLoad","HomoLoad","HeterLoad","RealizedLoad_h0.14"),names(LandranceBurden_GERP2_rm))
...
ggsave(p.f,filename ="Landrace_BurdenCorrelation_Sol100DerivedDele.pdf",height =6,width =6)
