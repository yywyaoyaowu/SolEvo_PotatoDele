...
geno_prefix=paste0("DMV6_AddNewAccession_chr",chr,"_merge_RefMissing_MR0.7_182Landrace")
...
BurdenInfor=data.frame(ConservationCutoff,Chrom,SnpNum_Combine,SnpNum,Conserved_SnpNnum,sample.id,HomeDeleNum_pre,HeterDeleNum_pre,HeterDeleNum,HomeDeleNum,Burden_index_EachiLine_Conserved,Burden_index_Heter_Conserved,Burden_index_Homo_Conserved)
write.table(BurdenInfor,paste("DMV6_chr",chr,"_GATKFilterd.snp_Landrace182MR0.5_ConservationCutoff",ConservationCutoff,"_SolMsaNonMajor_Dele_BurdenInfo_AddAccession_TurnOverRareDele.txt",sep=""),quote=F,row.name=F,sep='\t')
...
write.table(Dele_geno,paste("DeleBurden/DMV6_chr",chr,"_GATKFilterd.snp_Landrace182MR0.5_ConservationCutoff",ConservationCutoff,"_SolMsaNonMajor_DeleGenotype_AddAccession_TurnOverRareDele.txt",sep=""),quote=F,row.name=F,sep='\t')
