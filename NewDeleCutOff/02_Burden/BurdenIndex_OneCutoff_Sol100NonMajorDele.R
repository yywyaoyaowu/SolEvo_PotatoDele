...
#X_Conserved_rmNA=X_Conserved
#X_Conserved[is.na(X_Conserved)]<-0
#Burden_index_weightGERPZ_Conserved=X_Conserved_rmNA %*% w_Conserved
...
write.table(BurdenInfor,paste("DMV6_chr",chr,"_GATKFilterd.snp_Landrace182MR0.5_ConservationCutoff",ConservationCutoff,"_SolMsaNonMajor_Dele_BurdenInfo.txt",sep=""),quote=F,row.name=F,sep='\t')
