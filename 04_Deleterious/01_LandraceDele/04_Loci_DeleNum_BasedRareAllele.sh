...
cat SD_DeleLoci_DM_V6_Selected.txt  | awk 'NR>1' |  while read Loci     SD_population   V6_Chrom        V6_Start V6_End  others
do
 ...
 infor=Loci_${V6_Chrom}:${V6_Start}-${V6_End}_${Gene}
...
awk '($3>='${V6_Start}' && $3<='${V6_End}'){print}' ${GERP_chr_prefix}_Promoter_TSS1KupStream > ${Loci}_${infor}_Sol_msa.GERP_Promoter_TSS1kupStream
Promoter_TSS1K_Site_num=`cat   ${Loci}_${infor}_Sol_msa.GERP_Promoter_TSS1kupStream | wc -l`
Promoter_TSS1K_Poly_num=`awk '($1=="'${V6_Chrom}'" && $3>='${V6_Start}' && $3<='${V6_End}'){print}'  ${Poly_Freq_landrace}_Promoter_TSS1K | wc -l`
...
awk '($1=="'${V6_Chrom}'" && $3>='${V6_Start}' && $3<='${V6_End}'){print}' ${Poly_Freq_landrace}_PromoterTSS1K_Conserved2 > ${Loci}_${infor}_Promoter_TSS1kupStream_Conserved2_DeleLandrace
...
awk '($1=="'${V6_Chrom}'" && $3>='${V6_Start}' && $3<='${V6_End}'){print}'  ${Poly_Freq_landrace}_Genetic_Conserved2 > ${Loci}_${infor}_Genetic_Conserved2_DeleLandrace
